...
이 문서는 매일 아침 자동으로 오늘의 일정, 날씨, 주식 뉴스 브리핑을 수집해 Obsidian 볼트에 반영하는 **세컨드브레인 자동화 시스템**의 연동 및 설정 가이드입니다.
...
graph TD
    ...
    GHActions1["GHA 1: 데일리 일정 & 종합 브리핑<br>(매일 07:00 KST)"]
    GHActions2["GHA 2: 주식 & 반도체 뉴스 브리핑<br>(평일 07:30 KST)"]
    ...
    SubRepo -->|3. 스케줄 트리거| GHActions1
    SubRepo -->|3. 스케줄 트리거| GHActions2
    
    GHActions1 -->|4. 날씨 & 일정 분석| GeminiAPI
    GHActions2 -->|4. 주식/반도체 심층 뉴스 검색| GeminiAPI
    
    GeminiAPI -->|5. 마크다운 변환| OutputBriefing1
    GeminiAPI -->|5. 마크다운 변환| OutputBriefing2
    
    OutputBriefing1 -->|6. Git Push| SubRepo
    OutputBriefing2 -->|6. Git Push| SubRepo
...
- **트리거**: 매일 오전 **07:00 KST** (UTC 전날 22:00)
- **파일**: [daily-briefing.yml](file:///C:/Users/User/Desktop/second%20brain/%EC%9E%90%EB%8F%99%ED%99%94/%EC%84%B8%EC%BB%A8%EB%93%9C%EB%B8%8C%EB%A0%88%EC%9D%B8%EC%9E%90%EB%8F%99%ED%99%94/.github/workflows/daily-briefing.yml) ➡️ [briefing.py](file:///C:/Users/User/Desktop/second%20brain/%EC%9E%90%EB%8F%99%ED%99%94/%EC%84%B8%EC%BB%A8%EB%93%9C%EB%B8%8C%EB%A0%88%EC%9D%B8%EC%9E%90%EB%8F%99%ED%99%94/src/briefing.py)
- **내용**: 오늘/다가오는 로컬 일정 분석, 오늘 서울 날씨, 실시간 주요 이슈 및 관심 뉴스 요약.

### 2. 주식 & 반도체 뉴스 브리핑 (Stock Briefing)
- **트리거**: 평일(월-금) 오전 **07:30 KST** (UTC 일-목 22:30)
- **파일**: [stock-briefing.yml](file:///C:/Users/User/Desktop/second%20brain/%EC%9E%90%EB%8F%99%ED%99%94/%EC%84%B8%EC%BB%A8%EB%93%9C%EB%B8%8C%EB%A0%88%EC%9D%B8%EC%9E%90%EB%8F%99%ED%99%94/.github/workflows/stock-briefing.yml) ➡️ [stock_briefing.py](file:///C:/Users/User/Desktop/second%20brain/%EC%9E%90%EB%8F%99%ED%99%94/%EC%84%B8%EC%BB%A8%EB%93%9C%EB%B8%8C%EB%A0%88%EC%9D%B8%EC%9E%90%EB%8F%99%ED%99%94/src/stock_briefing.py)
- **내용**: **삼성전자, SK하이닉스, 엔비디아(Nvidia), 반도체 섹터 전반**의 주요 시장 움직임, 공시 및 해외 시황을 심층 수집 및 분석 요약.
